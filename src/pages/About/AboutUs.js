                    ...
                    <div className='row'>
                        <div className='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                            <div className='ABOUT-CONTENT-WRAPPER'>
                                ...
                                <p>TLC was born from a vision of providing an exquisite ambiance, unparalleled service quality, and cutting-edge beauty solutions, all while maintaining affordability. We've designed a sanctuary that stands alone in the region, boasting the most advanced technologies the wellness industry has to offer.</p>
                                <p>Our team, composed of seasoned professionals, is extensively trained in the latest beauty and wellness techniques. We pride ourselves on offering our clientele a personalized and distinctive experience, with the promise of leaving no stone unturned in our pursuit of their satisfaction.</p>
                                <p>We offer a diverse range of services, including but not limited to, salon services, hair treatments, skin therapies, nail extensions, pain management, wellness solutions, and hair extensions. Our recent addition, Laser Hair Removal, employs state-of-the-art equipment to deliver pain-free, precise results.</p>
                                <p>What sets us apart is our commitment to keeping abreast with the latest advancements in the field of dermatology. We are privileged to have frequent consultations with national derma specialists, enabling us to offer exclusive anti-aging treatments.</p>
                                <p>As we continue our journey as The Luxury Company, we have built a robust clientele who trust us for our expertise and exceptional service. We invite you to join us and discover a new level of indulgence, relaxation, and beauty transformation.</p>
                            </div>
                        </div>
                    </div>
                </div>
